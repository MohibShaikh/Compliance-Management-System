...
const TermsOfService = () => {
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      <Box sx={{ p: 3 }}>
        <Typography variant="h4" component="h1" gutterBottom id="acceptance">
          Terms of Service
        </Typography>
        ...
        <Typography variant="h6" gutterBottom id="responsibilities">
        ...
        <Typography variant="h6" gutterBottom id="privacy">
          4. Data Privacy
        </Typography>
        <Typography paragraph>
        ...
        <Typography variant="h6" gutterBottom id="disclaimer">
          5. Disclaimer
        </Typography>
        <Typography paragraph>
        ...
        <Typography variant="h6" gutterBottom id="limitations">
          6. Limitations
        </Typography>
        <Typography paragraph>
        ...
        <Typography variant="h6" gutterBottom id="revisions">
